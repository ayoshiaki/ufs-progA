...
stb.set_book_config(
    ...
    paths=[
        ...
        current / "14_padroes_funcionais",
        current / "15_arquivos_erros",
        current / "16_objetos",
        current / "17_encapsulamento",
        current / "18_heranca",
    ],
    icons=[
        "house", "lightbulb", "calculator", "toggles", "signpost-split",
        "arrow-repeat", "list-ul", "braces", "grid-3x3", "fonts", "box",
        "infinity", "arrow-right-circle", "funnel", "diagram-2",
        "file-earmark", "diagram-3", "shield-lock", "diagram-3-fill",
    ],
    save_answers=True,
